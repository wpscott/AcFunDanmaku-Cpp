...
class CommonStateSignalPkStatistic final :
 ...
 public:
  ...
  explicit constexpr CommonStateSignalPkStatistic(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CommonStateSignalPkStatistic* New() const final {
    return new CommonStateSignalPkStatistic();
  }
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::AcFunDanmu::PkRoundInfo* release_k();
