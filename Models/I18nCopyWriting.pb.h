...
class I18nCopyWriting final :
 ...
 public:
  ...
  explicit constexpr I18nCopyWriting(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_formatkey();
...
void I18nCopyWriting::set_formatkey(ArgT0&& arg0, ArgT... args) {
 ...
 formatkey_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void I18nCopyWriting::_internal_set_formatkey(const std::string& value) {
  ...
  formatkey_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* I18nCopyWriting::_internal_mutable_formatkey() {
  
  return formatkey_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* I18nCopyWriting::release_formatkey() {
  ...
  return formatkey_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
