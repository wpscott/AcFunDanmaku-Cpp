...
class CommonActionSignalUserFollowAuthor final :
 ...
 public:
  ...
  ~CommonActionSignalUserFollowAuthor() override;
  explicit PROTOBUF_CONSTEXPR CommonActionSignalUserFollowAuthor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CommonActionSignalUserFollowAuthor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CommonActionSignalUserFollowAuthor& from) {
    CommonActionSignalUserFollowAuthor::MergeImpl(*this, from);
  }
  private:
...
inline int64_t CommonActionSignalUserFollowAuthor::_internal_sendtimems() const {
  return _impl_.sendtimems_;
}
inline int64_t CommonActionSignalUserFollowAuthor::sendtimems() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.CommonActionSignalUserFollowAuthor.sendTimeMs)
  return _internal_sendtimems();
}
inline void CommonActionSignalUserFollowAuthor::_internal_set_sendtimems(int64_t value) {
  
  _impl_.sendtimems_ = value;
}
inline void CommonActionSignalUserFollowAuthor::set_sendtimems(int64_t value) {
