...
enum LiveFeatureState_FeatureType : int {
  ...
  LiveFeatureState_FeatureType_LiveFeatureState_FeatureType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  LiveFeatureState_FeatureType_LiveFeatureState_FeatureType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum LiveFeatureState_FeatureState : int {
  ...
  LiveFeatureState_FeatureState_LiveFeatureState_FeatureState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  LiveFeatureState_FeatureState_LiveFeatureState_FeatureState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class LiveFeatureState final :
 ...
 public:
  ...
  ~LiveFeatureState() override;
  explicit PROTOBUF_CONSTEXPR LiveFeatureState(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  LiveFeatureState* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const LiveFeatureState& from) {
    LiveFeatureState::MergeImpl(*this, from);
  }
  private:
...
inline ::AcFunDanmu::LiveFeatureState_FeatureType LiveFeatureState::_internal_type() const {
  return static_cast< ::AcFunDanmu::LiveFeatureState_FeatureType >(_impl_.type_);
}
...
inline ::AcFunDanmu::LiveFeatureState_FeatureState LiveFeatureState::_internal_state() const {
  return static_cast< ::AcFunDanmu::LiveFeatureState_FeatureState >(_impl_.state_);
}
