...
class CommonStateSignalChatReady final :
 ...
 public:
  ...
  explicit constexpr CommonStateSignalChatReady(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CommonStateSignalChatReady* New() const final {
    return new CommonStateSignalChatReady();
  }
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::AcFunDanmu::ZtLiveUserInfo* release_guestuserinfo();
