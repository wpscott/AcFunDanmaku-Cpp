...
constexpr CommonNotifySignalViolationAlert::CommonNotifySignalViolationAlert(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : violationcontent_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct CommonNotifySignalViolationAlertDefaultTypeInternal {
  constexpr CommonNotifySignalViolationAlertDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT CommonNotifySignalViolationAlertDefaultTypeInternal _CommonNotifySignalViolationAlert_default_instance_;
}  // namespace AcFunDanmu
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_CommonNotifySignalViolationAlert_2eproto = {
  false, false, 122, descriptor_table_protodef_CommonNotifySignalViolationAlert_2eproto, "CommonNotifySignalViolationAlert.proto", 
  ...
  file_level_metadata_CommonNotifySignalViolationAlert_2eproto, file_level_enum_descriptors_CommonNotifySignalViolationAlert_2eproto, file_level_service_descriptors_CommonNotifySignalViolationAlert_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_CommonNotifySignalViolationAlert_2eproto_getter() {
  return &descriptor_table_CommonNotifySignalViolationAlert_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_CommonNotifySignalViolationAlert_2eproto(&descriptor_table_CommonNotifySignalViolationAlert_2eproto);
namespace AcFunDanmu {
...
::PROTOBUF_NAMESPACE_ID::uint8* CommonNotifySignalViolationAlert::_InternalSerialize(
  ...
  // string violationContent = 1;
  if (!this->violationcontent().empty()) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:AcFunDanmu.CommonNotifySignalViolationAlert)
  ...
  if (!from.violationcontent().empty()) {
...
void CommonNotifySignalViolationAlert::InternalSwap(CommonNotifySignalViolationAlert* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &violationcontent_, GetArenaForAllocation(),
      &other->violationcontent_, other->GetArenaForAllocation()
  );
}
