...
class EnvInfo final :
 ...
 public:
  ...
  ~EnvInfo() override;
  explicit constexpr EnvInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void EnvInfo::set_appname(ArgT0&& arg0, ArgT... args) {
 
 appname_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
