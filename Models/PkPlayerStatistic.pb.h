...
class PkPlayerStatistic final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR PkPlayerStatistic(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PkPlayerStatistic* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const PkPlayerStatistic& from) {
    PkPlayerStatistic::MergeImpl(*this, from);
  }
  private:
...
inline int64_t PkPlayerStatistic::_internal_c() const {
  return _impl_.c_;
}
inline int64_t PkPlayerStatistic::c() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.PkPlayerStatistic.c)
  return _internal_c();
}
inline void PkPlayerStatistic::_internal_set_c(int64_t value) {
  
  _impl_.c_ = value;
}
inline void PkPlayerStatistic::set_c(int64_t value) {
...
inline ::AcFunDanmu::PkPlayerRoundStatistic* PkPlayerStatistic::add_d() {
  ::AcFunDanmu::PkPlayerRoundStatistic* _add = _internal_add_d();
...
inline int32_t PkPlayerStatistic::_internal_e() const {
  return _impl_.e_;
}
inline int32_t PkPlayerStatistic::e() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.PkPlayerStatistic.e)
  return _internal_e();
}
inline void PkPlayerStatistic::_internal_set_e(int32_t value) {
  
  _impl_.e_ = value;
}
inline void PkPlayerStatistic::set_e(int32_t value) {
