...
class ZtLiveCsUserExit final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:AcFunDanmu.ZtLiveCsUserExit) */ {
 public:
  inline ZtLiveCsUserExit() : ZtLiveCsUserExit(nullptr) {}
  explicit PROTOBUF_CONSTEXPR ZtLiveCsUserExit(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ZtLiveCsUserExit* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ZtLiveCsUserExit>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const ZtLiveCsUserExit& from) {
...
class ZtLiveCsUserExitAck final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:AcFunDanmu.ZtLiveCsUserExitAck) */ {
 public:
  inline ZtLiveCsUserExitAck() : ZtLiveCsUserExitAck(nullptr) {}
  explicit PROTOBUF_CONSTEXPR ZtLiveCsUserExitAck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ZtLiveCsUserExitAck* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ZtLiveCsUserExitAck>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const ZtLiveCsUserExitAck& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
