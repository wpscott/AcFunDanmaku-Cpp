...
class ZtLiveCsUserExit final :
 ...
 public:
  ...
  ~ZtLiveCsUserExit() override;
  explicit constexpr ZtLiveCsUserExit(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ZtLiveCsUserExitAck final :
 ...
 public:
  ...
  ~ZtLiveCsUserExitAck() override;
  explicit constexpr ZtLiveCsUserExitAck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline ZtLiveCsUserExitAck* New() const final {
    return new ZtLiveCsUserExitAck();
  }
