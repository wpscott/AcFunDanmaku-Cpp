...
class CommonStateSignalPKReady final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CommonStateSignalPKReady(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CommonStateSignalPKReady* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CommonStateSignalPKReady& from) {
    CommonStateSignalPKReady::MergeImpl(*this, from);
  }
  private:
...
inline ::AcFunDanmu::PkPlayerInfo* CommonStateSignalPKReady::add_b() {
  ::AcFunDanmu::PkPlayerInfo* _add = _internal_add_b();
