...
class PkRoundInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  inline PkRoundInfo* New() const final {
    return CreateMaybeMessage<PkRoundInfo>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_PkRoundInfo_2eproto);
    return ::descriptor_table_PkRoundInfo_2eproto.file_level_metadata[kIndexInFileMessages];
  }
