...
enum CommonStateSignalCurrentRedpackList_RedpackDisplayStatus : int {
  ...
  CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_e = 3,
  CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
constexpr CommonStateSignalCurrentRedpackList_RedpackDisplayStatus CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_RedpackDisplayStatus_MAX = CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_e;
...
class CommonStateSignalCurrentRedpackList_Redpack final :
 ...
 public:
  ...
  ~CommonStateSignalCurrentRedpackList_Redpack() override;
  explicit PROTOBUF_CONSTEXPR CommonStateSignalCurrentRedpackList_Redpack(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CommonStateSignalCurrentRedpackList_Redpack* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CommonStateSignalCurrentRedpackList_Redpack& from) {
    CommonStateSignalCurrentRedpackList_Redpack::MergeImpl(*this, from);
  }
  private:
  ...
  void set_redpackid(ArgT0&& arg0, ArgT... args);
  std::string* mutable_redpackid();
  PROTOBUF_NODISCARD std::string* release_redpackid();
  void set_allocated_redpackid(std::string* redpackid);
  private:
  const std::string& _internal_redpackid() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_redpackid(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_redpackbizunit(ArgT0&& arg0, ArgT... args);
  std::string* mutable_redpackbizunit();
  PROTOBUF_NODISCARD std::string* release_redpackbizunit();
  void set_allocated_redpackbizunit(std::string* redpackbizunit);
  private:
  const std::string& _internal_redpackbizunit() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_redpackbizunit(const std::string& value);
  ...
  PROTOBUF_NODISCARD ::AcFunDanmu::ZtLiveUserInfo* release_sender();
  ...
  int64_t grabbegintimems() const;
  void set_grabbegintimems(int64_t value);
  private:
  int64_t _internal_grabbegintimems() const;
  void _internal_set_grabbegintimems(int64_t value);
  public:

  // int64 getTokenLatestTimeMs = 4;
  void clear_gettokenlatesttimems();
  int64_t gettokenlatesttimems() const;
  void set_gettokenlatesttimems(int64_t value);
  private:
  int64_t _internal_gettokenlatesttimems() const;
  void _internal_set_gettokenlatesttimems(int64_t value);
  public:

  // int64 redpackAmount = 7;
  void clear_redpackamount();
  int64_t redpackamount() const;
  void set_redpackamount(int64_t value);
  private:
  int64_t _internal_redpackamount() const;
  void _internal_set_redpackamount(int64_t value);
  public:

  // int64 settleBeginTime = 8;
  void clear_settlebegintime();
  int64_t settlebegintime() const;
  void set_settlebegintime(int64_t value);
  private:
  int64_t _internal_settlebegintime() const;
  void _internal_set_settlebegintime(int64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int64_t grabbegintimems_;
    int64_t gettokenlatesttimems_;
    int64_t redpackamount_;
    int64_t settlebegintime_;
    int64_t i_;
    int displaystatus_;
...
class CommonStateSignalCurrentRedpackList final :
 ...
 public:
  ...
  ~CommonStateSignalCurrentRedpackList() override;
  explicit PROTOBUF_CONSTEXPR CommonStateSignalCurrentRedpackList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CommonStateSignalCurrentRedpackList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CommonStateSignalCurrentRedpackList& from) {
    CommonStateSignalCurrentRedpackList::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  static constexpr RedpackDisplayStatus e =
    CommonStateSignalCurrentRedpackList_RedpackDisplayStatus_e;
...
inline const ::AcFunDanmu::ZtLiveUserInfo& CommonStateSignalCurrentRedpackList_Redpack::_internal_sender() const {
  const ::AcFunDanmu::ZtLiveUserInfo* p = _impl_.sender_;
...
inline ::AcFunDanmu::ZtLiveUserInfo* CommonStateSignalCurrentRedpackList_Redpack::release_sender() {
  ...
  ::AcFunDanmu::ZtLiveUserInfo* temp = _impl_.sender_;
...
inline ::AcFunDanmu::ZtLiveUserInfo* CommonStateSignalCurrentRedpackList_Redpack::mutable_sender() {
  ::AcFunDanmu::ZtLiveUserInfo* _msg = _internal_mutable_sender();
...
inline ::AcFunDanmu::CommonStateSignalCurrentRedpackList_RedpackDisplayStatus CommonStateSignalCurrentRedpackList_Redpack::_internal_displaystatus() const {
  return static_cast< ::AcFunDanmu::CommonStateSignalCurrentRedpackList_RedpackDisplayStatus >(_impl_.displaystatus_);
}
...
inline void CommonStateSignalCurrentRedpackList_Redpack::clear_grabbegintimems() {
  _impl_.grabbegintimems_ = int64_t{0};
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::_internal_grabbegintimems() const {
  return _impl_.grabbegintimems_;
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::grabbegintimems() const {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::_internal_set_grabbegintimems(int64_t value) {
  
  _impl_.grabbegintimems_ = value;
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_grabbegintimems(int64_t value) {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::clear_gettokenlatesttimems() {
  _impl_.gettokenlatesttimems_ = int64_t{0};
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::_internal_gettokenlatesttimems() const {
  return _impl_.gettokenlatesttimems_;
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::gettokenlatesttimems() const {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::_internal_set_gettokenlatesttimems(int64_t value) {
  
  _impl_.gettokenlatesttimems_ = value;
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_gettokenlatesttimems(int64_t value) {
...
void CommonStateSignalCurrentRedpackList_Redpack::set_redpackid(ArgT0&& arg0, ArgT... args) {
 
 _impl_.redpackid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CommonStateSignalCurrentRedpackList_Redpack::mutable_redpackid() {
  std::string* _s = _internal_mutable_redpackid();
...
inline std::string* CommonStateSignalCurrentRedpackList_Redpack::release_redpackid() {
  ...
  return _impl_.redpackid_.Release();
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_allocated_redpackid(std::string* redpackid) {
  ...
  _impl_.redpackid_.SetAllocated(redpackid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.redpackid_.IsDefault()) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CommonStateSignalCurrentRedpackList_Redpack::set_redpackbizunit(ArgT0&& arg0, ArgT... args) {
 
 _impl_.redpackbizunit_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CommonStateSignalCurrentRedpackList_Redpack::mutable_redpackbizunit() {
  std::string* _s = _internal_mutable_redpackbizunit();
...
inline std::string* CommonStateSignalCurrentRedpackList_Redpack::release_redpackbizunit() {
  ...
  return _impl_.redpackbizunit_.Release();
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_allocated_redpackbizunit(std::string* redpackbizunit) {
  ...
  _impl_.redpackbizunit_.SetAllocated(redpackbizunit, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.redpackbizunit_.IsDefault()) {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::clear_redpackamount() {
  _impl_.redpackamount_ = int64_t{0};
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::_internal_redpackamount() const {
  return _impl_.redpackamount_;
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::redpackamount() const {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::_internal_set_redpackamount(int64_t value) {
  
  _impl_.redpackamount_ = value;
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_redpackamount(int64_t value) {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::clear_settlebegintime() {
  _impl_.settlebegintime_ = int64_t{0};
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::_internal_settlebegintime() const {
  return _impl_.settlebegintime_;
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::settlebegintime() const {
...
inline void CommonStateSignalCurrentRedpackList_Redpack::_internal_set_settlebegintime(int64_t value) {
  
  _impl_.settlebegintime_ = value;
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_settlebegintime(int64_t value) {
...
// int64 i = 9;
inline void CommonStateSignalCurrentRedpackList_Redpack::clear_i() {
  _impl_.i_ = int64_t{0};
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::_internal_i() const {
  return _impl_.i_;
}
inline int64_t CommonStateSignalCurrentRedpackList_Redpack::i() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.CommonStateSignalCurrentRedpackList.Redpack.i)
  return _internal_i();
}
inline void CommonStateSignalCurrentRedpackList_Redpack::_internal_set_i(int64_t value) {
  
  _impl_.i_ = value;
}
inline void CommonStateSignalCurrentRedpackList_Redpack::set_i(int64_t value) {
  _internal_set_i(value);
  // @@protoc_insertion_point(field_set:AcFunDanmu.CommonStateSignalCurrentRedpackList.Redpack.i)
}
...
inline ::AcFunDanmu::CommonStateSignalCurrentRedpackList_Redpack* CommonStateSignalCurrentRedpackList::mutable_redpacks(int index) {
  ...
  return _impl_.redpacks_.Mutable(index);
}
...
inline const ::AcFunDanmu::CommonStateSignalCurrentRedpackList_Redpack& CommonStateSignalCurrentRedpackList::_internal_redpacks(int index) const {
  return _impl_.redpacks_.Get(index);
}
