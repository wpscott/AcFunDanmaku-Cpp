...
class ZtDrawGiftInfo_ZtDrawPoint final :
 ...
 public:
  ...
  explicit constexpr ZtDrawGiftInfo_ZtDrawPoint(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline ZtDrawGiftInfo_ZtDrawPoint* New() const final {
    return new ZtDrawGiftInfo_ZtDrawPoint();
  }
...
class ZtDrawGiftInfo final :
 ...
 public:
  ...
  explicit constexpr ZtDrawGiftInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
