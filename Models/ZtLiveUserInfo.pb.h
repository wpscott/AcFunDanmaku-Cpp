...
class ZtLiveUserInfo final :
 ...
 public:
  ...
  explicit constexpr ZtLiveUserInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_badge();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::AcFunDanmu::ZtLiveUserIdentity* release_useridentity();
...
void ZtLiveUserInfo::set_badge(ArgT0&& arg0, ArgT... args) {
 ...
 badge_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ZtLiveUserInfo::_internal_set_badge(const std::string& value) {
  ...
  badge_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ZtLiveUserInfo::_internal_mutable_badge() {
  
  return badge_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ZtLiveUserInfo::release_badge() {
  // @@protoc_insertion_point(field_release:AcFunDanmu.ZtLiveUserInfo.badge)
  return badge_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
