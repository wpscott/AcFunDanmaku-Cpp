...
class ZtLiveScActionSignal final :
 ...
 public:
  ...
  ~ZtLiveScActionSignal() override;
  explicit PROTOBUF_CONSTEXPR ZtLiveScActionSignal(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ZtLiveScActionSignal* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ZtLiveScActionSignal& from) {
    ZtLiveScActionSignal::MergeImpl(*this, from);
  }
  private:
...
inline ::AcFunDanmu::ZtLiveActionSignalItem* ZtLiveScActionSignal::add_item() {
  ::AcFunDanmu::ZtLiveActionSignalItem* _add = _internal_add_item();
