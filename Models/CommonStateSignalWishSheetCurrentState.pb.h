...
class CommonStateSignalWishSheetCurrentState_WishCurrentState final :
 ...
 public:
  ...
  explicit constexpr CommonStateSignalWishSheetCurrentState_WishCurrentState(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CommonStateSignalWishSheetCurrentState_WishCurrentState* New() const final {
    return new CommonStateSignalWishSheetCurrentState_WishCurrentState();
  }
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_g();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_h();
...
class CommonStateSignalWishSheetCurrentState final :
 ...
 public:
  ...
  explicit constexpr CommonStateSignalWishSheetCurrentState(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CommonStateSignalWishSheetCurrentState* New() const final {
    return new CommonStateSignalWishSheetCurrentState();
  }
...
void CommonStateSignalWishSheetCurrentState_WishCurrentState::set_c(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CommonStateSignalWishSheetCurrentState_WishCurrentState::set_g(ArgT0&& arg0, ArgT... args) {
 
 g_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CommonStateSignalWishSheetCurrentState_WishCurrentState::_internal_set_g(const std::string& value) {
  ...
  g_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CommonStateSignalWishSheetCurrentState_WishCurrentState::_internal_mutable_g() {
  
  return g_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CommonStateSignalWishSheetCurrentState_WishCurrentState::release_g() {
  ...
  return g_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CommonStateSignalWishSheetCurrentState_WishCurrentState::set_h(ArgT0&& arg0, ArgT... args) {
 
 h_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CommonStateSignalWishSheetCurrentState_WishCurrentState::_internal_set_h(const std::string& value) {
  ...
  h_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CommonStateSignalWishSheetCurrentState_WishCurrentState::_internal_mutable_h() {
  
  return h_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CommonStateSignalWishSheetCurrentState_WishCurrentState::release_h() {
  ...
  return h_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
