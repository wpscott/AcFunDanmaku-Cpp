...
class CommonActionSignalGift final :
 ...
 public:
  ...
  explicit constexpr CommonActionSignalGift(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CommonActionSignalGift* New() const final {
    return new CommonActionSignalGift();
  }
  ...
  void set_comboid(ArgT0&& arg0, ArgT... args);
  std::string* mutable_comboid();
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_comboid();
  void set_allocated_comboid(std::string* comboid);
  private:
  const std::string& _internal_comboid() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_comboid(const std::string& value);
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::AcFunDanmu::ZtDrawGiftInfo* release_drawgiftinfo();
...
void CommonActionSignalGift::set_comboid(ArgT0&& arg0, ArgT... args) {
 
 comboid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CommonActionSignalGift::_internal_set_comboid(const std::string& value) {
  ...
  comboid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CommonActionSignalGift::_internal_mutable_comboid() {
  
  return comboid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CommonActionSignalGift::release_comboid() {
  ...
  return comboid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
