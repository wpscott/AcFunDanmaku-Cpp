...
inline void CommonActionSignalGift::_internal_set_comboid(const std::string& value) {
  ...
  comboid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void CommonActionSignalGift::set_comboid(const char* value) {
  ...
  comboid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.CommonActionSignalGift.comboId)
}
inline void CommonActionSignalGift::set_comboid(const char* value,
    size_t size) {
  
  comboid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* CommonActionSignalGift::_internal_mutable_comboid() {
  ...
  return comboid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
