...
class ZtLiveScStatusChanged_BannedInfo final :
 ...
 public:
  ...
  explicit constexpr ZtLiveScStatusChanged_BannedInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline ZtLiveScStatusChanged_BannedInfo* New() const final {
    return new ZtLiveScStatusChanged_BannedInfo();
  }
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_banreason();
...
class ZtLiveScStatusChanged final :
 ...
 public:
  ...
  explicit constexpr ZtLiveScStatusChanged(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline ZtLiveScStatusChanged* New() const final {
    return new ZtLiveScStatusChanged();
  }
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::AcFunDanmu::ZtLiveScStatusChanged_BannedInfo* release_bannedinfo();
...
void ZtLiveScStatusChanged_BannedInfo::set_banreason(ArgT0&& arg0, ArgT... args) {
 ...
 banreason_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ZtLiveScStatusChanged_BannedInfo::_internal_set_banreason(const std::string& value) {
  ...
  banreason_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ZtLiveScStatusChanged_BannedInfo::_internal_mutable_banreason() {
  
  return banreason_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ZtLiveScStatusChanged_BannedInfo::release_banreason() {
  ...
  return banreason_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void ZtLiveScStatusChanged::set_allocated_bannedinfo(::AcFunDanmu::ZtLiveScStatusChanged_BannedInfo* bannedinfo) {
  ...
  if (bannedinfo) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::AcFunDanmu::ZtLiveScStatusChanged_BannedInfo>::GetOwningArena(bannedinfo);
