...
class ZtLiveScMessage final :
 ...
 public:
  ...
  explicit constexpr ZtLiveScMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_messagetype();
...
void ZtLiveScMessage::set_messagetype(ArgT0&& arg0, ArgT... args) {
 ...
 messagetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ZtLiveScMessage::_internal_set_messagetype(const std::string& value) {
  ...
  messagetype_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ZtLiveScMessage::_internal_mutable_messagetype() {
  
  return messagetype_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ZtLiveScMessage::release_messagetype() {
  ...
  return messagetype_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
