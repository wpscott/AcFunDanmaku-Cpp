...
class AuthorChatPlayerInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  ::AcFunDanmu::ZtLiveUserInfo* release_player();
...
inline void AuthorChatPlayerInfo::set_liveid(const std::string& value) {
...
inline void AuthorChatPlayerInfo::set_liveid(std::string&& value) {
  
  liveid_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.AuthorChatPlayerInfo.liveId)
}
inline void AuthorChatPlayerInfo::set_liveid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  liveid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.AuthorChatPlayerInfo.liveId)
}
inline void AuthorChatPlayerInfo::set_liveid(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.AuthorChatPlayerInfo.liveId)
}
