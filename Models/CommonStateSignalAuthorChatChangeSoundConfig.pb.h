...
enum CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType : int {
  ...
  CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType_CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType_CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class CommonStateSignalAuthorChatChangeSoundConfig final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CommonStateSignalAuthorChatChangeSoundConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  CommonStateSignalAuthorChatChangeSoundConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const CommonStateSignalAuthorChatChangeSoundConfig& from) {
    CommonStateSignalAuthorChatChangeSoundConfig::MergeImpl(*this, from);
  }
  private:
...
inline ::AcFunDanmu::CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType CommonStateSignalAuthorChatChangeSoundConfig::_internal_soundconfigchangetype() const {
  return static_cast< ::AcFunDanmu::CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType >(_impl_.soundconfigchangetype_);
}
...
inline void CommonStateSignalAuthorChatChangeSoundConfig::_internal_set_soundconfigchangetype(::AcFunDanmu::CommonStateSignalAuthorChatChangeSoundConfig_SoundConfigChangeType value) {
  ...
  _impl_.soundconfigchangetype_ = value;
}
