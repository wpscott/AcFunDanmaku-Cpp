...
class CommonStateSignalAuthorChatChangeSoundConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~CommonStateSignalAuthorChatChangeSoundConfig();
  ...
  inline CommonStateSignalAuthorChatChangeSoundConfig* New() const final {
    return CreateMaybeMessage<CommonStateSignalAuthorChatChangeSoundConfig>(nullptr);
  }
...
inline void CommonStateSignalAuthorChatChangeSoundConfig::set_authorchatid(const std::string& value) {
...
inline void CommonStateSignalAuthorChatChangeSoundConfig::set_authorchatid(std::string&& value) {
  
  authorchatid_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.CommonStateSignalAuthorChatChangeSoundConfig.authorChatId)
}
inline void CommonStateSignalAuthorChatChangeSoundConfig::set_authorchatid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  authorchatid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.CommonStateSignalAuthorChatChangeSoundConfig.authorChatId)
}
inline void CommonStateSignalAuthorChatChangeSoundConfig::set_authorchatid(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.CommonStateSignalAuthorChatChangeSoundConfig.authorChatId)
}
