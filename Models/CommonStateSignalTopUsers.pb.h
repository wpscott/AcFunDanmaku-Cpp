...
inline void CommonStateSignalTopUsers_TopUser::_internal_set_customwatchinglistdata(const std::string& value) {
  ...
  customwatchinglistdata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void CommonStateSignalTopUsers_TopUser::set_customwatchinglistdata(const char* value) {
  ...
  customwatchinglistdata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.CommonStateSignalTopUsers.TopUser.customWatchingListData)
}
inline void CommonStateSignalTopUsers_TopUser::set_customwatchinglistdata(const char* value,
    size_t size) {
  
  customwatchinglistdata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* CommonStateSignalTopUsers_TopUser::_internal_mutable_customwatchinglistdata() {
  ...
  return customwatchinglistdata_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void CommonStateSignalTopUsers_TopUser::_internal_set_displaysendamount(const std::string& value) {
  ...
  displaysendamount_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void CommonStateSignalTopUsers_TopUser::set_displaysendamount(const char* value) {
  ...
  displaysendamount_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.CommonStateSignalTopUsers.TopUser.displaySendAmount)
}
inline void CommonStateSignalTopUsers_TopUser::set_displaysendamount(const char* value,
    size_t size) {
  
  displaysendamount_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* CommonStateSignalTopUsers_TopUser::_internal_mutable_displaysendamount() {
  ...
  return displaysendamount_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
