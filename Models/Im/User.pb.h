...
PROTOBUF_NAMESPACE_OPEN
template<> ::AcFunDanmu::Im::Basic::User* Arena::CreateMaybeMessage<::AcFunDanmu::Im::Basic::User>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace AcFunDanmu {
namespace Im {
namespace Basic {
...
inline int32_t User::_internal_appid() const {
  return _impl_.appid_;
}
inline int32_t User::appid() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.Im.Basic.User.appId)
  return _internal_appid();
}
inline void User::_internal_set_appid(int32_t value) {
  
  _impl_.appid_ = value;
}
inline void User::set_appid(int32_t value) {
