...
#ifndef GOOGLE_PROTOBUF_INCLUDED_AccountType_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_AccountType_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_AccountType_2eproto
...
struct TableStruct_AccountType_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AccountType_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
...
constexpr AccountType AccountType_MIN = UNKNOW;
constexpr AccountType AccountType_MAX = STRANGER;
...
template <> struct is_proto_enum< ::AcFunDanmu::Im::Message::AccountType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AcFunDanmu::Im::Message::AccountType>() {
  return ::AcFunDanmu::Im::Message::AccountType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_AccountType_2eproto
