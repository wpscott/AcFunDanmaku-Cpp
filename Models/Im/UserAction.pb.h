...
#ifndef GOOGLE_PROTOBUF_INCLUDED_UserAction_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_UserAction_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_UserAction_2eproto
...
struct TableStruct_UserAction_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_UserAction_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
...
constexpr UserAction UserAction_MIN = USER_ACTION_UNKNOWN;
constexpr UserAction UserAction_MAX = USER_OFFLINE;
...
template <> struct is_proto_enum< ::AcFunDanmu::Im::Cloud::Channel::UserAction> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AcFunDanmu::Im::Cloud::Channel::UserAction>() {
  return ::AcFunDanmu::Im::Cloud::Channel::UserAction_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_UserAction_2eproto
