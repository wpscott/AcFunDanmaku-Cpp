...
enum LinkErrorCode : int {
  ...
  BASIC_MAX = 19999,
  LinkErrorCode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  LinkErrorCode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
template <> struct is_proto_enum< ::AcFunDanmu::Im::Basic::LinkErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AcFunDanmu::Im::Basic::LinkErrorCode>() {
  return ::AcFunDanmu::Im::Basic::LinkErrorCode_descriptor();
}
