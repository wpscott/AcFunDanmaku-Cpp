...
PROTOBUF_NAMESPACE_OPEN
template<> ::AcFunDanmu::Im::Basic::AppInfo* Arena::CreateMaybeMessage<::AcFunDanmu::Im::Basic::AppInfo>(Arena*);
template<> ::AcFunDanmu::Im::Basic::AppInfo_ExtensionInfoEntry_DoNotUse* Arena::CreateMaybeMessage<::AcFunDanmu::Im::Basic::AppInfo_ExtensionInfoEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace AcFunDanmu {
namespace Im {
namespace Basic {
...
public:
  ...
  explicit PROTOBUF_CONSTEXPR AppInfo_ExtensionInfoEntry_DoNotUse(
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "AcFunDanmu.Im.Basic.AppInfo.ExtensionInfoEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "AcFunDanmu.Im.Basic.AppInfo.ExtensionInfoEntry.value");
 }
...
class AppInfo final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_appchannel();
  ...
  PROTOBUF_NODISCARD std::string* release_linkversion();
...
inline void AppInfo::set_allocated_appchannel(std::string* appchannel) {
  ...
  _impl_.appchannel_.SetAllocated(appchannel, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.appchannel_.IsDefault()) {
...
inline const std::string& AppInfo::linkversion() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.Im.Basic.AppInfo.linkVersion)
...
void AppInfo::set_linkversion(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.linkversion_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:AcFunDanmu.Im.Basic.AppInfo.linkVersion)
}
inline std::string* AppInfo::mutable_linkversion() {
  std::string* _s = _internal_mutable_linkversion();
  // @@protoc_insertion_point(field_mutable:AcFunDanmu.Im.Basic.AppInfo.linkVersion)
  return _s;
}
inline const std::string& AppInfo::_internal_linkversion() const {
  return _impl_.linkversion_.Get();
}
inline void AppInfo::_internal_set_linkversion(const std::string& value) {
  
  _impl_.linkversion_.Set(value, GetArenaForAllocation());
}
inline std::string* AppInfo::_internal_mutable_linkversion() {
  
  return _impl_.linkversion_.Mutable(GetArenaForAllocation());
}
inline std::string* AppInfo::release_linkversion() {
  // @@protoc_insertion_point(field_release:AcFunDanmu.Im.Basic.AppInfo.linkVersion)
  return _impl_.linkversion_.Release();
}
inline void AppInfo::set_allocated_linkversion(std::string* linkversion) {
  ...
  _impl_.linkversion_.SetAllocated(linkversion, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.linkversion_.IsDefault()) {
    _impl_.linkversion_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:AcFunDanmu.Im.Basic.AppInfo.linkVersion)
}

// map<string, string> extensionInfo = 11;
inline int AppInfo::_internal_extensioninfo_size() const {
  return _impl_.extensioninfo_.size();
}
...
AppInfo::_internal_extensioninfo() const {
  return _impl_.extensioninfo_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
AppInfo::extensioninfo() const {
  // @@protoc_insertion_point(field_map:AcFunDanmu.Im.Basic.AppInfo.extensionInfo)
  return _internal_extensioninfo();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
AppInfo::_internal_mutable_extensioninfo() {
  return _impl_.extensioninfo_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
AppInfo::mutable_extensioninfo() {
  // @@protoc_insertion_point(field_mutable_map:AcFunDanmu.Im.Basic.AppInfo.extensionInfo)
