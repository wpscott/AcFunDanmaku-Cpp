...
#ifndef GOOGLE_PROTOBUF_INCLUDED_GroupQuitResponse_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_GroupQuitResponse_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_GroupQuitResponse_2eproto
...
struct TableStruct_GroupQuitResponse_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GroupQuitResponse_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse* Arena::CreateMaybeMessage<::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace AcFunDanmu {
namespace Im {
namespace Cloud {
...
class GroupQuitResponse final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_GroupQuitResponse_2eproto;
};
// ===================================================================
...
// string groupId = 1;
inline void GroupQuitResponse::clear_groupid() {
  _impl_.groupid_.ClearToEmpty();
}
inline const std::string& GroupQuitResponse::groupid() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.Im.Cloud.Message.GroupQuitResponse.groupId)
  return _internal_groupid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GroupQuitResponse::set_groupid(ArgT0&& arg0, ArgT... args) {
...
inline std::string* GroupQuitResponse::mutable_groupid() {
...
inline const std::string& GroupQuitResponse::_internal_groupid() const {
  return _impl_.groupid_.Get();
}
inline void GroupQuitResponse::_internal_set_groupid(const std::string& value) {
  
  _impl_.groupid_.Set(value, GetArenaForAllocation());
}
inline std::string* GroupQuitResponse::_internal_mutable_groupid() {
  
  return _impl_.groupid_.Mutable(GetArenaForAllocation());
}
inline std::string* GroupQuitResponse::release_groupid() {
  // @@protoc_insertion_point(field_release:AcFunDanmu.Im.Cloud.Message.GroupQuitResponse.groupId)
  return _impl_.groupid_.Release();
}
inline void GroupQuitResponse::set_allocated_groupid(std::string* groupid) {
  if (groupid != nullptr) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_GroupQuitResponse_2eproto
