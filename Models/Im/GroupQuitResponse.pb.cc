...
#include "GroupQuitResponse.pb.h"
...
static ::_pb::Metadata file_level_metadata_GroupQuitResponse_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_GroupQuitResponse_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_GroupQuitResponse_2eproto = nullptr;

const uint32_t TableStruct_GroupQuitResponse_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse, _impl_.groupid_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::AcFunDanmu::Im::Cloud::Message::_GroupQuitResponse_default_instance_._instance,
};

const char descriptor_table_protodef_GroupQuitResponse_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027GroupQuitResponse.proto\022\033AcFunDanmu.Im"
  ".Cloud.Message\"$\n\021GroupQuitResponse\022\017\n\007g"
  "roupId\030\001 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_GroupQuitResponse_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_GroupQuitResponse_2eproto = {
    false, false, 100, descriptor_table_protodef_GroupQuitResponse_2eproto,
    "GroupQuitResponse.proto",
    &descriptor_table_GroupQuitResponse_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_GroupQuitResponse_2eproto::offsets,
    file_level_metadata_GroupQuitResponse_2eproto, file_level_enum_descriptors_GroupQuitResponse_2eproto,
    file_level_service_descriptors_GroupQuitResponse_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_GroupQuitResponse_2eproto_getter() {
  return &descriptor_table_GroupQuitResponse_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_GroupQuitResponse_2eproto(&descriptor_table_GroupQuitResponse_2eproto);
namespace AcFunDanmu {
namespace Im {
namespace Cloud {
namespace Message {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "AcFunDanmu.Im.Cloud.Message.GroupQuitResponse.groupId"));
        } else
          goto handle_unusual;
        continue;
      default:
...
::PROTOBUF_NAMESPACE_ID::Metadata GroupQuitResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_GroupQuitResponse_2eproto_getter, &descriptor_table_GroupQuitResponse_2eproto_once,
      file_level_metadata_GroupQuitResponse_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse*
Arena::CreateMaybeMessage< ::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::AcFunDanmu::Im::Cloud::Message::GroupQuitResponse >(arena);
}
