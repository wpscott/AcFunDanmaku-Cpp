...
#ifndef GOOGLE_PROTOBUF_INCLUDED_GroupDeleteRequest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_GroupDeleteRequest_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_GroupDeleteRequest_2eproto
...
struct TableStruct_GroupDeleteRequest_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GroupDeleteRequest_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::AcFunDanmu::Im::Cloud::Message::GroupDeleteRequest* Arena::CreateMaybeMessage<::AcFunDanmu::Im::Cloud::Message::GroupDeleteRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace AcFunDanmu {
namespace Im {
namespace Cloud {
...
class GroupDeleteRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GroupDeleteRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GroupDeleteRequest(const GroupDeleteRequest& from);
  ...
  GroupDeleteRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit GroupDeleteRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_GroupDeleteRequest_2eproto;
};
// ===================================================================
...
// string groupId = 1;
inline void GroupDeleteRequest::clear_groupid() {
  _impl_.groupid_.ClearToEmpty();
}
inline const std::string& GroupDeleteRequest::groupid() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.Im.Cloud.Message.GroupDeleteRequest.groupId)
  return _internal_groupid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GroupDeleteRequest::set_groupid(ArgT0&& arg0, ArgT... args) {
...
inline std::string* GroupDeleteRequest::mutable_groupid() {
...
inline const std::string& GroupDeleteRequest::_internal_groupid() const {
  return _impl_.groupid_.Get();
}
inline void GroupDeleteRequest::_internal_set_groupid(const std::string& value) {
  
  _impl_.groupid_.Set(value, GetArenaForAllocation());
}
inline std::string* GroupDeleteRequest::_internal_mutable_groupid() {
  
  return _impl_.groupid_.Mutable(GetArenaForAllocation());
}
inline std::string* GroupDeleteRequest::release_groupid() {
...
inline void GroupDeleteRequest::set_allocated_groupid(std::string* groupid) {
  if (groupid != nullptr) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_GroupDeleteRequest_2eproto
