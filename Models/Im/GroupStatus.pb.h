...
#ifndef GOOGLE_PROTOBUF_INCLUDED_GroupStatus_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_GroupStatus_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_GroupStatus_2eproto
...
struct TableStruct_GroupStatus_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GroupStatus_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
...
constexpr GroupStatus GroupStatus_MIN = UNKNOW_GROUP_STATUS;
constexpr GroupStatus GroupStatus_MAX = INVALID;
...
template <> struct is_proto_enum< ::AcFunDanmu::Im::Cloud::Message::GroupStatus> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AcFunDanmu::Im::Cloud::Message::GroupStatus>() {
  return ::AcFunDanmu::Im::Cloud::Message::GroupStatus_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_GroupStatus_2eproto
