...
#ifndef GOOGLE_PROTOBUF_INCLUDED_UnregisterRequest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_UnregisterRequest_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_UnregisterRequest_2eproto
...
struct TableStruct_UnregisterRequest_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_UnregisterRequest_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::AcFunDanmu::Im::Basic::UnregisterRequest* Arena::CreateMaybeMessage<::AcFunDanmu::Im::Basic::UnregisterRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace AcFunDanmu {
namespace Im {
namespace Basic {
...
class UnregisterRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:AcFunDanmu.Im.Basic.UnregisterRequest) */ {
 public:
  ...
  inline void CopyFrom(const UnregisterRequest& from) {
 ...
 private:
  ...
  friend struct ::TableStruct_UnregisterRequest_2eproto;
};
// ===================================================================
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_UnregisterRequest_2eproto
