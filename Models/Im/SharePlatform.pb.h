...
enum SharePlatform : int {
  ...
  SharePlatform_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SharePlatform_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
template <> struct is_proto_enum< ::AcFunDanmu::Im::Basic::SharePlatform> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AcFunDanmu::Im::Basic::SharePlatform>() {
  return ::AcFunDanmu::Im::Basic::SharePlatform_descriptor();
}
