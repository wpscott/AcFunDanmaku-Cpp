...
enum ZtLiveUserIdentity_ManagerType : int {
  ...
  ZtLiveUserIdentity_ManagerType_ZtLiveUserIdentity_ManagerType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ZtLiveUserIdentity_ManagerType_ZtLiveUserIdentity_ManagerType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class ZtLiveUserIdentity final :
 ...
 public:
  ...
  ~ZtLiveUserIdentity() override;
  explicit PROTOBUF_CONSTEXPR ZtLiveUserIdentity(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ZtLiveUserIdentity* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ZtLiveUserIdentity& from) {
    ZtLiveUserIdentity::MergeImpl(*this, from);
  }
  private:
...
inline ::AcFunDanmu::ZtLiveUserIdentity_ManagerType ZtLiveUserIdentity::_internal_managertype() const {
  return static_cast< ::AcFunDanmu::ZtLiveUserIdentity_ManagerType >(_impl_.managertype_);
}
