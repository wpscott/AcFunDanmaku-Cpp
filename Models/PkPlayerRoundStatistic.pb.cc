...
constexpr PkPlayerRoundStatistic::PkPlayerRoundStatistic(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : a_(int64_t{0})
  , b_(0){}
struct PkPlayerRoundStatisticDefaultTypeInternal {
  constexpr PkPlayerRoundStatisticDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PkPlayerRoundStatisticDefaultTypeInternal _PkPlayerRoundStatistic_default_instance_;
}  // namespace AcFunDanmu
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_PkPlayerRoundStatistic_2eproto = {
  false, false, 98, descriptor_table_protodef_PkPlayerRoundStatistic_2eproto, "PkPlayerRoundStatistic.proto", 
  ...
  file_level_metadata_PkPlayerRoundStatistic_2eproto, file_level_enum_descriptors_PkPlayerRoundStatistic_2eproto, file_level_service_descriptors_PkPlayerRoundStatistic_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_PkPlayerRoundStatistic_2eproto_getter() {
  return &descriptor_table_PkPlayerRoundStatistic_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_PkPlayerRoundStatistic_2eproto(&descriptor_table_PkPlayerRoundStatistic_2eproto);
namespace AcFunDanmu {
