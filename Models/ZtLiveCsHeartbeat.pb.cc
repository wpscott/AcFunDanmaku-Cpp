...
constexpr ZtLiveCsHeartbeat::ZtLiveCsHeartbeat(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : clienttimestampms_(int64_t{0})
  , sequence_(int64_t{0}){}
struct ZtLiveCsHeartbeatDefaultTypeInternal {
  constexpr ZtLiveCsHeartbeatDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ZtLiveCsHeartbeatDefaultTypeInternal _ZtLiveCsHeartbeat_default_instance_;
constexpr ZtLiveCsHeartbeatAck::ZtLiveCsHeartbeatAck(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : servertimestampms_(int64_t{0})
  , clienttimestampms_(int64_t{0})
  , clientsequence_(int64_t{0}){}
struct ZtLiveCsHeartbeatAckDefaultTypeInternal {
  constexpr ZtLiveCsHeartbeatAckDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ZtLiveCsHeartbeatAckDefaultTypeInternal _ZtLiveCsHeartbeatAck_default_instance_;
}  // namespace AcFunDanmu
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ZtLiveCsHeartbeat_2eproto = {
  false, false, 213, descriptor_table_protodef_ZtLiveCsHeartbeat_2eproto, "ZtLiveCsHeartbeat.proto", 
  ...
  file_level_metadata_ZtLiveCsHeartbeat_2eproto, file_level_enum_descriptors_ZtLiveCsHeartbeat_2eproto, file_level_service_descriptors_ZtLiveCsHeartbeat_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ZtLiveCsHeartbeat_2eproto_getter() {
  return &descriptor_table_ZtLiveCsHeartbeat_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ZtLiveCsHeartbeat_2eproto(&descriptor_table_ZtLiveCsHeartbeat_2eproto);
namespace AcFunDanmu {
