...
class SdkOption final :
 ...
 public:
  ...
  ~SdkOption() override;
  explicit constexpr SdkOption(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_reportsecurity();
...
void SdkOption::set_reportsecurity(ArgT0&& arg0, ArgT... args) {
 ...
 reportsecurity_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SdkOption::_internal_set_reportsecurity(const std::string& value) {
  ...
  reportsecurity_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SdkOption::_internal_mutable_reportsecurity() {
  
  return reportsecurity_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SdkOption::release_reportsecurity() {
  ...
  return reportsecurity_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
