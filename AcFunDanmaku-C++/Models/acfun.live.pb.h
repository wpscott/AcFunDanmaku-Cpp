...
inline void AcfunStateSignalDisplayInfo::clear_bananacount() {
  bananacount_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline void AcfunStateSignalDisplayInfo::_internal_set_bananacount(const std::string& value) {
  ...
  bananacount_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void AcfunStateSignalDisplayInfo::set_bananacount(const char* value) {
  ...
  bananacount_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void AcfunStateSignalDisplayInfo::set_bananacount(const char* value,
  ...
  bananacount_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* AcfunStateSignalDisplayInfo::_internal_mutable_bananacount() {
  ...
  return bananacount_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
