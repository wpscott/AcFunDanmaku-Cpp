...
class CommonActionSignalUserEnterRoom PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~CommonActionSignalUserEnterRoom();
  ...
  inline CommonActionSignalUserEnterRoom* New() const final {
    return CreateMaybeMessage<CommonActionSignalUserEnterRoom>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_CommonActionSignalUserEnterRoom_2eproto);
    return ::descriptor_table_CommonActionSignalUserEnterRoom_2eproto.file_level_metadata[kIndexInFileMessages];
  }
