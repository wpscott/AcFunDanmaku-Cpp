...
constexpr AccessPoint_AddressType AccessPoint_AddressType_AddressType_MAX = AccessPoint_AddressType_kDomain;
...
class AccessPoint PROTOBUF_FINAL :
 ...
 public:
  ...
  inline AccessPoint* New() const final {
    return CreateMaybeMessage<AccessPoint>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_AccessPoint_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void AccessPoint::set_ipv6(const std::string& value) {
...
inline void AccessPoint::set_ipv6(std::string&& value) {
  
  ipv6_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.AccessPoint.ipV6)
}
inline void AccessPoint::set_ipv6(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  ipv6_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.AccessPoint.ipV6)
}
inline void AccessPoint::set_ipv6(const void* value,
    size_t size) {
  
  ipv6_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.AccessPoint.ipV6)
}
...
inline void AccessPoint::set_domain(const std::string& value) {
...
inline void AccessPoint::set_domain(std::string&& value) {
  
  domain_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.AccessPoint.domain)
}
inline void AccessPoint::set_domain(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.AccessPoint.domain)
}
inline void AccessPoint::set_domain(const char* value,
    size_t size) {
  ...
  domain_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.AccessPoint.domain)
}
