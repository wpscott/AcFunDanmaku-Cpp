...
static constexpr ::PROTOBUF_NAMESPACE_ID::Metadata* file_level_metadata_ZtLiveDownstreamPayloadErrorCode_2eproto = nullptr;
...
const char descriptor_table_protodef_ZtLiveDownstreamPayloadErrorCode_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto_sccs[1] = {
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto = {
  false, false, descriptor_table_protodef_ZtLiveDownstreamPayloadErrorCode_2eproto, "ZtLiveDownstreamPayloadErrorCode.proto", 214,
  &descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto_once, descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto_sccs, descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto_deps, 0, 0,
  schemas, file_default_instances, TableStruct_ZtLiveDownstreamPayloadErrorCode_2eproto::offsets,
  file_level_metadata_ZtLiveDownstreamPayloadErrorCode_2eproto, 0, file_level_enum_descriptors_ZtLiveDownstreamPayloadErrorCode_2eproto, file_level_service_descriptors_ZtLiveDownstreamPayloadErrorCode_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ZtLiveDownstreamPayloadErrorCode_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ZtLiveDownstreamPayloadErrorCode_2eproto)), true);
namespace AcFunDanmu {
