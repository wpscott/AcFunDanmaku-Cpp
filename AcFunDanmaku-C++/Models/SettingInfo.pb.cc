...
static void InitDefaultsscc_info_SettingInfo_SettingInfo_2eproto() {
  ...
  ::AcFunDanmu::SettingInfo::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_SettingInfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::SettingInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::SettingInfo, locale_),
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::SettingInfo, timezone_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::AcFunDanmu::SettingInfo)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::AcFunDanmu::_SettingInfo_default_instance_),
};

const char descriptor_table_protodef_SettingInfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021SettingInfo.proto\022\nAcFunDanmu\"/\n\013Setti"
...
SettingInfo::SettingInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:AcFunDanmu.SettingInfo)
}
...
SettingInfo::~SettingInfo() {
  // @@protoc_insertion_point(destructor:AcFunDanmu.SettingInfo)
  SharedDtor();
...
void SettingInfo::ArenaDtor(void* object) {
  SettingInfo* _this = reinterpret_cast< SettingInfo* >(object);
  (void)_this;
}
void SettingInfo::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* SettingInfo::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "AcFunDanmu.SettingInfo.locale"));
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* SettingInfo::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:AcFunDanmu.SettingInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:AcFunDanmu.SettingInfo)
  return target;
}

size_t SettingInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:AcFunDanmu.SettingInfo)
  size_t total_size = 0;
...
void SettingInfo::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:AcFunDanmu.SettingInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const SettingInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SettingInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:AcFunDanmu.SettingInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:AcFunDanmu.SettingInfo)
    MergeFrom(*source);
  }
}

void SettingInfo::MergeFrom(const SettingInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:AcFunDanmu.SettingInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void SettingInfo::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:AcFunDanmu.SettingInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:AcFunDanmu.SettingInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::AcFunDanmu::SettingInfo* Arena::CreateMaybeMessage< ::AcFunDanmu::SettingInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::AcFunDanmu::SettingInfo >(arena);
}
