...
static void InitDefaultsscc_info_ZtLiveScStateSignal_ZtLiveScStateSignal_2eproto() {
  ...
  ::AcFunDanmu::ZtLiveScStateSignal::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ZtLiveScStateSignal_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::ZtLiveScStateSignal, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::AcFunDanmu::ZtLiveScStateSignal, item_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::AcFunDanmu::ZtLiveScStateSignal)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::AcFunDanmu::_ZtLiveScStateSignal_default_instance_),
};
...
void ZtLiveScStateSignal::InitAsDefaultInstance() {
}
...
void ZtLiveScStateSignal::ArenaDtor(void* object) {
  ZtLiveScStateSignal* _this = reinterpret_cast< ZtLiveScStateSignal* >(object);
  (void)_this;
}
void ZtLiveScStateSignal::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* ZtLiveScStateSignal::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
::PROTOBUF_NAMESPACE_ID::uint8* ZtLiveScStateSignal::_InternalSerialize(
...
void ZtLiveScStateSignal::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:AcFunDanmu.ZtLiveScStateSignal)
  GOOGLE_DCHECK_NE(&from, this);
  const ZtLiveScStateSignal* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ZtLiveScStateSignal>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:AcFunDanmu.ZtLiveScStateSignal)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:AcFunDanmu.ZtLiveScStateSignal)
    MergeFrom(*source);
  }
}

void ZtLiveScStateSignal::MergeFrom(const ZtLiveScStateSignal& from) {
...
void ZtLiveScStateSignal::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:AcFunDanmu.ZtLiveScStateSignal)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::AcFunDanmu::ZtLiveScStateSignal* Arena::CreateMaybeMessage< ::AcFunDanmu::ZtLiveScStateSignal >(Arena* arena) {
