...
inline void SdkOption::_internal_set_reportsecurity(const std::string& value) {
  ...
  reportsecurity_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void SdkOption::set_reportsecurity(const char* value) {
  ...
  reportsecurity_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void SdkOption::set_reportsecurity(const char* value,
  ...
  reportsecurity_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* SdkOption::_internal_mutable_reportsecurity() {
  ...
  return reportsecurity_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
