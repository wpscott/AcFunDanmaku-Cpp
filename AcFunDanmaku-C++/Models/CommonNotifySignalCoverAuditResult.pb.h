...
enum CommonNotifySignalCoverAuditResult_AuditStatus : int {
  ...
  CommonNotifySignalCoverAuditResult_AuditStatus_CommonNotifySignalCoverAuditResult_AuditStatus_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  CommonNotifySignalCoverAuditResult_AuditStatus_CommonNotifySignalCoverAuditResult_AuditStatus_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class CommonNotifySignalCoverAuditResult PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~CommonNotifySignalCoverAuditResult();
  ...
  inline CommonNotifySignalCoverAuditResult* New() const final {
    return CreateMaybeMessage<CommonNotifySignalCoverAuditResult>(nullptr);
  }

  CommonNotifySignalCoverAuditResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_CommonNotifySignalCoverAuditResult_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::AcFunDanmu::CommonNotifySignalCoverAuditResult_AuditStatus CommonNotifySignalCoverAuditResult::_internal_auditstatus() const {
  return static_cast< ::AcFunDanmu::CommonNotifySignalCoverAuditResult_AuditStatus >(auditstatus_);
}
