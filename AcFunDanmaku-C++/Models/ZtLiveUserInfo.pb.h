...
inline void ZtLiveUserInfo::_internal_set_badge(const std::string& value) {
  ...
  badge_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void ZtLiveUserInfo::set_badge(const char* value) {
  ...
  badge_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ZtLiveUserInfo::set_badge(const char* value,
  ...
  badge_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ZtLiveUserInfo::_internal_mutable_badge() {
  ...
  return badge_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
