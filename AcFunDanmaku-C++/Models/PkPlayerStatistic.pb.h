...
class PkPlayerStatistic PROTOBUF_FINAL :
 ...
 public:
  ...
  inline PkPlayerStatistic* New() const final {
    return CreateMaybeMessage<PkPlayerStatistic>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_PkPlayerStatistic_2eproto);
    return ::descriptor_table_PkPlayerStatistic_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void PkPlayerStatistic::set_b(const std::string& value) {
...
inline void PkPlayerStatistic::set_b(std::string&& value) {
  
  b_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.PkPlayerStatistic.b)
}
inline void PkPlayerStatistic::set_b(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  b_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.PkPlayerStatistic.b)
}
inline void PkPlayerStatistic::set_b(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.PkPlayerStatistic.b)
}
