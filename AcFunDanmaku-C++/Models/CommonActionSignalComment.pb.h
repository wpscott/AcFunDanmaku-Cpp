...
class CommonActionSignalComment PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~CommonActionSignalComment();
  ...
  inline CommonActionSignalComment* New() const final {
    return CreateMaybeMessage<CommonActionSignalComment>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_CommonActionSignalComment_2eproto);
    return ::descriptor_table_CommonActionSignalComment_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline void CommonActionSignalComment::set_content(const std::string& value) {
...
inline void CommonActionSignalComment::set_content(std::string&& value) {
  
  content_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.CommonActionSignalComment.content)
}
inline void CommonActionSignalComment::set_content(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  content_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.CommonActionSignalComment.content)
}
inline void CommonActionSignalComment::set_content(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.CommonActionSignalComment.content)
}
