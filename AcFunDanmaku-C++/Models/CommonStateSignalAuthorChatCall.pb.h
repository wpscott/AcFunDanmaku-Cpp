...
// string a = 1;
inline void CommonStateSignalAuthorChatCall::clear_a() {
  a_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& CommonStateSignalAuthorChatCall::a() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
  return _internal_a();
}
inline void CommonStateSignalAuthorChatCall::set_a(const std::string& value) {
  _internal_set_a(value);
  // @@protoc_insertion_point(field_set:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
}
inline std::string* CommonStateSignalAuthorChatCall::mutable_a() {
  // @@protoc_insertion_point(field_mutable:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
  return _internal_mutable_a();
}
inline const std::string& CommonStateSignalAuthorChatCall::_internal_a() const {
  return a_.Get();
}
inline void CommonStateSignalAuthorChatCall::_internal_set_a(const std::string& value) {
  
  a_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void CommonStateSignalAuthorChatCall::set_a(std::string&& value) {
  
  a_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
}
inline void CommonStateSignalAuthorChatCall::set_a(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  a_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
}
inline void CommonStateSignalAuthorChatCall::set_a(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
}
inline std::string* CommonStateSignalAuthorChatCall::_internal_mutable_a() {
  
  return a_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* CommonStateSignalAuthorChatCall::release_a() {
  // @@protoc_insertion_point(field_release:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
  return a_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void CommonStateSignalAuthorChatCall::set_allocated_a(std::string* a) {
  if (a != nullptr) {
  ...
  a_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), a,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:AcFunDanmu.CommonStateSignalAuthorChatCall.a)
}

// .AcFunDanmu.AuthorChatPlayerInfo b = 2;
inline bool CommonStateSignalAuthorChatCall::_internal_has_b() const {
  return this != internal_default_instance() && b_ != nullptr;
}
inline bool CommonStateSignalAuthorChatCall::has_b() const {
  return _internal_has_b();
}
inline const ::AcFunDanmu::AuthorChatPlayerInfo& CommonStateSignalAuthorChatCall::_internal_b() const {
...
inline const ::AcFunDanmu::AuthorChatPlayerInfo& CommonStateSignalAuthorChatCall::b() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.CommonStateSignalAuthorChatCall.b)
  return _internal_b();
}
inline void CommonStateSignalAuthorChatCall::unsafe_arena_set_allocated_b(
    ::AcFunDanmu::AuthorChatPlayerInfo* b) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:AcFunDanmu.CommonStateSignalAuthorChatCall.b)
}
inline ::AcFunDanmu::AuthorChatPlayerInfo* CommonStateSignalAuthorChatCall::release_b() {
...
inline ::AcFunDanmu::AuthorChatPlayerInfo* CommonStateSignalAuthorChatCall::unsafe_arena_release_b() {
  // @@protoc_insertion_point(field_release:AcFunDanmu.CommonStateSignalAuthorChatCall.b)
  
  ::AcFunDanmu::AuthorChatPlayerInfo* temp = b_;
  b_ = nullptr;
  return temp;
}
inline ::AcFunDanmu::AuthorChatPlayerInfo* CommonStateSignalAuthorChatCall::_internal_mutable_b() {
...
inline ::AcFunDanmu::AuthorChatPlayerInfo* CommonStateSignalAuthorChatCall::mutable_b() {
  // @@protoc_insertion_point(field_mutable:AcFunDanmu.CommonStateSignalAuthorChatCall.b)
  return _internal_mutable_b();
}
inline void CommonStateSignalAuthorChatCall::set_allocated_b(::AcFunDanmu::AuthorChatPlayerInfo* b) {
  ...
  b_ = b;
  // @@protoc_insertion_point(field_set_allocated:AcFunDanmu.CommonStateSignalAuthorChatCall.b)
}

// int64 c = 3;
inline void CommonStateSignalAuthorChatCall::clear_c() {
  c_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CommonStateSignalAuthorChatCall::_internal_c() const {
  return c_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CommonStateSignalAuthorChatCall::c() const {
  // @@protoc_insertion_point(field_get:AcFunDanmu.CommonStateSignalAuthorChatCall.c)
  return _internal_c();
}
inline void CommonStateSignalAuthorChatCall::_internal_set_c(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  c_ = value;
}
inline void CommonStateSignalAuthorChatCall::set_c(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_c(value);
  // @@protoc_insertion_point(field_set:AcFunDanmu.CommonStateSignalAuthorChatCall.c)
}
