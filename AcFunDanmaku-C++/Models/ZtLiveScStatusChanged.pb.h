...
inline void ZtLiveScStatusChanged_BannedInfo::_internal_set_banreason(const std::string& value) {
  ...
  banreason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void ZtLiveScStatusChanged_BannedInfo::set_banreason(const char* value) {
  ...
  banreason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ZtLiveScStatusChanged_BannedInfo::set_banreason(const char* value,
  ...
  banreason_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* ZtLiveScStatusChanged_BannedInfo::_internal_mutable_banreason() {
  ...
  return banreason_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
