...
namespace Command
{
	inline static const std::string HANDSHAKE = "Basic.Handshake";
...
namespace PushMessage
{
	...
	namespace ActionSignal
	{
		...
		inline static const std::string JOIN_CLUB = "AcfunActionSignalJoinClub";
	}; // namespace ActionSignal
	...
	namespace StateSignal
	{
		...
		inline static const std::string PK_ACCEPT = "CommonStateSignalPKAccept";
		inline static const std::string PK_INVITATION = "CommonStateSignalPKInvitation";
		inline static const std::string PK_READY = "CommonStateSignalPKReady";
		inline static const std::string PK_SOUND_CONFIG_CHANGED = "CommonStateSignalPKSoundConfigChanged";
		inline static const std::string PK_END = "CommonStateSignalPkEnd";
		inline static const std::string PK_STATISTICS = "CommonStateSignalPkStatistic";
		inline static const std::string WISH_SHEET_CURRENT_STATE = "CommonStateSignalWishSheetCurrentState";
		inline static const std::string AR_LIVE_TREASURE_BOX_STATE = "CommonStateSignalArLiveTreasureBoxState";
	} // namespace StateSignal
