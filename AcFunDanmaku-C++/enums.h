...
namespace Command {
	...
	inline static const std::string GLOBAL_COMMAND = "Global.ZtLiveInteractive.CsCmd";
...
namespace PushMessage {
	...
	namespace StateSignal {
		inline static const std::string ACFUN_DISPLAY_INFO = "AcfunStateSignalDisplayInfo";
		...
		inline static const std::string RECENT_COMMENT = "CommonStateSignalRecentComment";
		...
		inline static const std::string CURRENT_RED_PACK_LIST = "CommonStateSignalCurrentRedpackList";
		inline static const std::string AUTHOR_CHAT_CALL = "CommonStateSignalAuthorChatCall";
		inline static const std::string AUTHOR_CHAT_ACCEPT = "CommonStateSignalAuthorChatAccept";
		inline static const std::string AUTHOR_CHAT_READY = "CommonStateSignalAuthorChatReady";
		inline static const std::string AUTHOR_CHAT_END = "CommonStateSignalAuthorChatEnd";
		inline static const std::string AUTHOR_CHAT_CHANGE_SOUND_CONFIG = "CommonStateSignalAuthorChatChangeSoundConfig";
	}

	namespace NotifySignal {
		inline static const std::string KICKED_OUT = "CommonNotifySignalKickedOut";
		inline static const std::string VIOLATION_ALERT = "CommonNotifySignalViolationAlert";
		inline static const std::string LIVE_MANAGER_STATE = "CommonNotifySignalLiveManagerState";
	}
};